...
clock = Tk()
clock.title('**** Akbar-s Clock ****')
clock.geometry('1000x500')
clock.config(bg='#444444')  # Use the hexadecimal color code for metallic grey
...
lab_am=Label(clock,text="00",font=('Time New Roman',52,"bold"),
               bg='red',fg="white")
